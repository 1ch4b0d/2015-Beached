...
namespace Acrocatic {
    ...
    public class PlayerLadder : MonoBehaviour {
        ...
        // Private variables.
        public Acrocatic.Player player;                      // Get the Player class.
        ...
        void FixedUpdate() {
            ...
            float v = SimpleInputManager.Instance.GetAxis("Vertical");
            float h = SimpleInputManager.Instance.GetAxis("Horizontal");
        ...
        void Update() {
            ...
            if(player.onLadder && ladder && ladder.allowJump && SimpleInputManager.Instance.GetButtonDown("Jump")) {
